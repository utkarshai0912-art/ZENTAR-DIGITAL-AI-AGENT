...
Config: ~/.zentar/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.zentar/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zentar_home()`` helper (ZENTAR_HOME-aware and
...
RULES_FILE = get_zentar_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zentar_home() / "feishu_comment_pairing.json"
