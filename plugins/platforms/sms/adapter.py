...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Zentar gateway adapter.

    Each inbound phone number gets its own Zentar session (multi-tenant).
...
# static dict in zentar_cli/gateway.py, and the _send_sms dispatch in
