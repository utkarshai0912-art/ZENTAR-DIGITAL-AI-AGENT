...
required — uses aiohttp which is already a Zentar dependency.
...
def interactive_setup() -> None:
    ...
    ``zentar_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Zentar delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # zentar_cli/setup.py::_setup_mattermost function.
