# Zentar Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.zentar/plugins/zentar-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.zentar/plugins/zentar-achievements/scan_checkpoint.json`.
