# Zentar Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.zentar/plugins/zentar-achievements/state.json` (existing unlock state)
  - `~/.zentar/plugins/zentar-achievements/scan_snapshot.json` (new)
  - `~/.zentar/plugins/zentar-achievements/scan_checkpoint.json` (new)
