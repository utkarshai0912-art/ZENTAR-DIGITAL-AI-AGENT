...
Configuration
-------------
Secret (lives in $ZENTAR_HOME/.env or the environment):
...
Behavioral settings (live in $ZENTAR_HOME/mem0.json, set via `zentar memory
setup`):
  ...
  agent_id           — Agent identifier (default: zentar)
...
def _load_config() -> dict:
    """Load config from env vars, with $ZENTAR_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "zentar"),
        "oss": {},
    }
    ...
    config_path = get_zentar_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, zentar_home):
        """Write config to $ZENTAR_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ZENTAR_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "zentar")
