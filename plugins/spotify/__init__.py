...
``_check_spotify_available()`` — when the user has not run ``zentar auth
spotify``, the tools remain registered (so they appear in ``zentar
...
The Spotify auth flow (``zentar auth spotify``), CLI plumbing, and docs
