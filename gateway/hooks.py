...
Hooks are discovered from ~/.zentar/hooks/ directories, each containing:
...
HOOKS_DIR = get_zentar_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"zentar_hook_{hook_name}"
