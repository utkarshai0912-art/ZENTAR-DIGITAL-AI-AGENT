...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ZENTAR_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_zentar_dir("platforms/whatsapp/session", "whatsapp/session")
