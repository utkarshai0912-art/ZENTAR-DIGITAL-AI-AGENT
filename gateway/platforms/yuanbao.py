...
try:
    ...
    _ZENTAR_VERSION = "0.0.0"

_APP_VERSION = _ZENTAR_VERSION
_BOT_VERSION = _ZENTAR_VERSION
_YUANBAO_INSTANCE_ID = str(ZENTAR_INSTANCE_ID)  # single source: yuanbao_proto.ZENTAR_INSTANCE_ID
