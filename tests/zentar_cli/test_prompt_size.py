"""Tests for the ``zentar prompt-size`` diagnostic (issue #34667)."""
...
from zentar_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(zentar_home, memory_text="", user_text=""):
    mem_dir = zentar_home / "memories"
...
def _seed_skill(zentar_home, name, description):
    skill_dir = zentar_home / "skills" / "demo" / name
