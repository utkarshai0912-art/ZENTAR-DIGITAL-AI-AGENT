"""Tests for the specifier module + `zentar kanban specify` CLI surface.
...
from zentar_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `zentar kanban …` argparse surface directly."""
