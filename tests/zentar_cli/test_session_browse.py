"""Tests for the interactive session browser (`zentar sessions browse`).
...
from zentar_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zentar sessions browse should be parseable."""
