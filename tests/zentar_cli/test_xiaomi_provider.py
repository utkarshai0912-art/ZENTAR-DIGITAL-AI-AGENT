...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from zentar_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZENTAR_OVERLAYS
        overlay = ZENTAR_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify zentar doctor recognizes Xiaomi env vars."""
