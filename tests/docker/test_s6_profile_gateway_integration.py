...
The unit tests in tests/zentar_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned zentar-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/zentar")
from zentar_cli.service_manager import S6ServiceManager
