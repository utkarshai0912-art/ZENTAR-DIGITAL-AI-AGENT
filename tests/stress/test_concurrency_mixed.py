...
def worker_loop(worker_id: int, zentar_home: str, result_file: str) -> None:
...
def reclaimer_loop(zentar_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="zentar_mixed_stress_")
    print(f"ZENTAR_HOME = {home}")
