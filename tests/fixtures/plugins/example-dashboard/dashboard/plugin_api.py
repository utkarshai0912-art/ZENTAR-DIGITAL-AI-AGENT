...
part of the bundled-plugins set; a stock zentar-digital-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/zentar_cli/test_web_server.py`` copies this directory
into ``$ZENTAR_HOME/plugins/example-dashboard/`` and forces the dashboard
