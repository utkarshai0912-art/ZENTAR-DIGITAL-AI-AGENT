...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "zentar_approve_once" in action_ids
        assert "zentar_approve_session" in action_ids
        assert "zentar_approve_always" in action_ids
        assert "zentar_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "zentar_deny", "value": "session-key"}
