"""Tests for _setup_feishu() in zentar_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("zentar_cli.config.save_env_value", side_effect=mock_save), \
         patch("zentar_cli.config.get_env_value", side_effect=mock_get), \
         patch("zentar_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("zentar_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("zentar_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("zentar_cli.cli_output.print_header"), \
         patch("zentar_cli.cli_output.print_info"), \
         patch("zentar_cli.cli_output.print_success"), \
         patch("zentar_cli.cli_output.print_warning"), \
         patch("zentar_cli.cli_output.print_error"), \
