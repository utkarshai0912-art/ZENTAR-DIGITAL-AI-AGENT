...
def store(tmp_path, monkeypatch):
    ...
    ~/.zentar/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at zentar_state import time, before pytest's ZENTAR_HOME monkeypatch
    fires — the autouse fixture's ZENTAR_HOME override doesn't help here.)
    """
    import zentar_state
