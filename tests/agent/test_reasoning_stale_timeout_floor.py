...
thinking phase.  Zentar's default cloud-stream stale detector
(``ZENTAR_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ZENTAR_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
