...
def test_zentar_meta_tolerates_non_dict():
    assert learning_graph._zentar_meta({"metadata": "junk"}) == {}
    assert learning_graph._zentar_meta({"metadata": {"zentar": "junk"}}) == {}
    assert learning_graph._zentar_meta({"metadata": {"zentar": {"category": "x"}}}) == {"category": "x"}
