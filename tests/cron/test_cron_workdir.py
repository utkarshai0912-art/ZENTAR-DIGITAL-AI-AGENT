...
class TestRunJobTerminalCwd:
    ...
    def _install_stubs(monkeypatch, observed: dict):
        ...
        # Bypass the real provider resolver — it reads ~/.zentar and credentials.
        from zentar_cli import runtime_provider as _rtp
        monkeypatch.setattr(
            _rtp,
        ...
        # run_job calls load_dotenv(~/.zentar/.env, override=True), which will
