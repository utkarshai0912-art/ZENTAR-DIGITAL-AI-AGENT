...
Data file: $ZENTAR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZENTAR_HOME = Path(os.environ.get("ZENTAR_HOME", Path.home() / ".zentar"))
DATA_DIR = _ZENTAR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
