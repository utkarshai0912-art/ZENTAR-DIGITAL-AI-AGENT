#!/usr/bin/env python3
"""
stocks_client.py - Stock market data CLI tool for the ZENTAR DIGITAL AI AGENT project.
...
USER_AGENT = "Mozilla/5.0 (compatible; ZentarAgent/1.0)"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stocks_client",
        description="Stock & crypto market data CLI — ZENTAR DIGITAL AI AGENT",
