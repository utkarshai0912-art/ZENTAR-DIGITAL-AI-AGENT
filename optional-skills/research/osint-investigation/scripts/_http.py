...
DEFAULT_UA = (
    "zentar-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/hermes-digital-agent; "
    "set ZENTAR_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ZENTAR_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
