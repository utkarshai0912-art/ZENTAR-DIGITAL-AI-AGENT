import { Box, type ScrollBoxHandle, stringWidth, Text } from '@zentar/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ZENTAR_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ZENTAR_DEV_CREDITS), lowest priority,
