 ...
 *
 * Symptom: in `zentar --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@zentar/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using zentar --tui and as i type multiline my caret at the end will often ' +
