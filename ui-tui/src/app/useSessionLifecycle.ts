...
import type { ScrollBoxHandle } from '@zentar/ink'
import { evictInkCaches } from '@zentar/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZENTAR_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
