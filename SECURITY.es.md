# Política de Seguridad de ZENTAR DIGITAL AI AGENT

Este documento describe el modelo de confianza de ZENTAR DIGITAL AI AGENT, identifica el
...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/NousResearch/hermes-digital-agent/security/advisories/new)
o **security@nousresearch.com**. No abras issues públicos para
vulnerabilidades de seguridad. **ZENTAR DIGITAL AI AGENT no opera un programa de
...
- Detalles del entorno (`zentar version`, SHA del commit, SO, versión de Python).
...
ZENTAR DIGITAL AI AGENT es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta ZENTAR DIGITAL AI AGENT,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a ZENTAR DIGITAL AI AGENT al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de ZENTAR DIGITAL AI AGENT
...
ZENTAR DIGITAL AI AGENT admite dos posturas de aislamiento a nivel de SO. Abordan
...
ZENTAR DIGITAL AI AGENT admite esto de dos maneras:

- **La propia imagen Docker de ZENTAR DIGITAL AI AGENT y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de ZENTAR DIGITAL AI AGENT
...
ZENTAR DIGITAL AI AGENT filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en ZENTAR DIGITAL AI AGENT
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de ZENTAR DIGITAL AI AGENT
...
**Superficies en ZENTAR DIGITAL AI AGENT:**
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   ZENTAR DIGITAL AI AGENT no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de ZENTAR DIGITAL AI AGENT o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  ZENTAR DIGITAL AI AGENT ha documentado una postura sobre cómo su salida debe ser
...
- **Configuraciones documentadas de emergencia.** Compensaciones seleccionadas por el operador
  ...
  la seguridad de zentar-home, y similares. Los informes contra esas
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de ZENTAR DIGITAL AI AGENT
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en ZENTAR DIGITAL AI AGENT. Los errores en la ruta de
  instalación de habilidades o plugins de ZENTAR DIGITAL AI AGENT que impidan al
...
- ZENTAR DIGITAL AI AGENT incluye guardias de cadena de suministro para lanzamientos de servidores
