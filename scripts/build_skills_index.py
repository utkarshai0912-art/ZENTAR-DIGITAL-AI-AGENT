#!/usr/bin/env python3
"""Build the Zentar Skills Index — a centralized JSON catalog of all skills.
...
`zentar skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZENTAR_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Zentar Skills Index...", flush=True)
