...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Zentar\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "zentar@nousresearch.com",
    "zentar-audit@example.com",
    "zentar@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/zentar-digital-agent",
                "--state", "merged",
