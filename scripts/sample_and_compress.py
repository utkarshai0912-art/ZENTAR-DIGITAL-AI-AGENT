...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zentar-digital-agent-megascience-sft1",
    "NousResearch/Zentar-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zentar-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zentar-digital-agent"
]
