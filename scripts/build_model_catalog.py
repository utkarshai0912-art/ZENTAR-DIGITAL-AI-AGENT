#!/usr/bin/env python3
"""Build the Zentar Model Catalog — a centralized JSON manifest of curated models.
...
Zentar CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Zentar release.
...
# Ensure ZENTAR_HOME is set for imports that touch it at module level.
os.environ.setdefault("ZENTAR_HOME", os.path.join(os.path.expanduser("~"), ".zentar"))

from zentar_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "zentar-digital-agent repo",
