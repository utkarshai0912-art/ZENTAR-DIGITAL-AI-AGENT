...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_zentar_digital_agent_browser()
    ),
...
def _has_zentar_digital_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ZENTAR_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ZentarHome", str(get_zentar_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = zentar_subprocess_env(inherit_credentials=False)
