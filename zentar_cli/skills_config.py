"""
Skills configuration for ZENTAR DIGITAL AI AGENT.
`zentar skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zentar/config.yaml under:
...
from zentar_cli.config import cfg_get, load_config, save_config
from zentar_cli.colors import Colors, color
from zentar_cli.platforms import PLATFORMS as _PLATFORMS
