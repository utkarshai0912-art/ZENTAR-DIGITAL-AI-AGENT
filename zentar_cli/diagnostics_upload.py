"""Client for uploading ``zentar debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``zentar debug share``.
...
NAS_BASE = os.environ.get(
    "ZENTAR_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "zentar-digital-agent/debug-share"
