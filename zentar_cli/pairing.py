...
Usage:
    zentar pairing list              # Show all pending + approved users
    zentar pairing approve <platform> <code>  # Approve a pairing code
    zentar pairing revoke <platform> <user_id> # Revoke user access
    zentar pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zentar pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zentar pairing {list|approve|revoke|clear-pending}")
        print("Run 'zentar pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.zentar/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'zentar pairing list' to see pending codes.\n")
