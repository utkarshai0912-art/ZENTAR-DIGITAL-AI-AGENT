...
Entry point: ``zentar whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``zentar_cli/main.py``).
...
Zentar gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Zentar to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Zentar needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Zentar gateway in another terminal:")
    print("         zentar gateway")
    print()
