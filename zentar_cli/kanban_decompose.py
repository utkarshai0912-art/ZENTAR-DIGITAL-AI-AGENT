...
Invoked by ``zentar kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the ZENTAR DIGITAL AI AGENT board.
...
def _profile_author() -> str:
    """Mirror of ``zentar_cli.kanban._profile_author``."""
    return (
