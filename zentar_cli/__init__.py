"""
Zentar CLI - Unified command-line interface for ZENTAR DIGITAL AI AGENT.

Provides subcommands for:
- zentar chat          - Interactive chat (same as ./zentar)
- zentar gateway       - Run gateway in foreground
- zentar gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `zentar setup` on a fresh Pi.
    ...
    zentar_cli/stdio.py::configure_windows_stdio() runs later from the entry
