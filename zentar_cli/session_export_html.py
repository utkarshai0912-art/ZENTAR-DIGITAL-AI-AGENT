"""
HTML Export generator for Zentar sessions.
...
<body>
    <div class="layout {layout_class}">
        ...
        <div class="main-content">
            ...
            <footer>
                Built with ☤ ZENTAR DIGITAL AI AGENT • Generated on {generated_at}
            </footer>
        </div>
    </div>
...
def generate_multi_session_html_export(sessions: List[Dict[str, Any]]) -> str:
    ...
    for s in sessions:
        sid = s.get("id", "N/A")
        title = s.get("title") or "Zentar Session"
    ...
    return HTML_TEMPLATE.format(
        page_title="Zentar Session Export" if is_multi else _escape_html(sessions[0].get("title", "Zentar Session")),
