"""``zentar uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall ZENTAR DIGITAL AI AGENT",
        description="Remove ZENTAR DIGITAL AI AGENT from your system. Can keep configs/data for reinstall.",
    )
