"""``zentar tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'zentar tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # zentar tools list [--platform cli]
    ...
    # zentar tools disable <name...> [--platform cli]
    ...
    # zentar tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `zentar tools` runs after you pick a provider that\n"
