...
def _profile_user_agent() -> str:
    """Return a ``zentar-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from zentar_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"zentar-cli/{_ver}"
    except Exception:
        return "zentar-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # zentar-cli UA so the catalog endpoint is reachable.
