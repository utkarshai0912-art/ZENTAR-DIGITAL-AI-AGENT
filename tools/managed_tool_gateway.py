...
def auth_json_path():
    """Return the Zentar auth store path, respecting ZENTAR_HOME overrides."""
    return get_zentar_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`zentar tools`, banner/status paint, provider
