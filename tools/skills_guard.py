...
Trust levels:
  - builtin:   Ships with Zentar. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zentar/\.env|\~/\.zentar/\.env',
     "zentar_env_access", "critical", "exfiltration",
     "directly references Zentar secrets file"),
    ...
    (r'\.zentar/config\.yaml|\.zentar/SOUL\.md',
     "zentar_config_mod", "critical", "persistence",
     "references Zentar configuration files directly"),
...
# scan. `.skillignore` is the Zentar-native name; `.clawhubignore` is honored
