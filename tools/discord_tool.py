...
Only included in the zentar-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Zentar-Agent (https://github.com/NousResearch/hermes-digital-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_zentar_home() / "cache" / "discord_capabilities.json"
