...
Built for [ZENTAR DIGITAL AI AGENT](https://github.com/NousResearch/hermes-digital-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/zentar-digital-agent/skills/creative/ascii-video`](https://github.com/NousResearch/hermes-digital-agent/tree/main/skills/creative/ascii-video) via PR.
