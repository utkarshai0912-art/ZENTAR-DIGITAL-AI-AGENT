...
const config: Config = {
  ...
  projectName: 'zentar-digital-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-zentar-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/hermes-digital-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/zentar-digital-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/NousResearch/hermes-digital-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/hermes-digital-agent/issues' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub', href: 'https://github.com/NousResearch/hermes-digital-agent' },
            { label: 'ZENTAR DIGITAL', href: 'https://nousresearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://nousresearch.com">ZENTAR DIGITAL</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
