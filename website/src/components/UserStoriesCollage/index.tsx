  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the ZENTAR DIGITAL AI AGENT community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Zentar &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Zentar?{' '}
        <a
          href="https://github.com/NousResearch/hermes-digital-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
