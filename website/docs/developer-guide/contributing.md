...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to ZENTAR DIGITAL AI AGENT — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to ZENTAR DIGITAL AI AGENT! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Zentar core? Start with [Build a Zentar Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Zentar itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.zentar/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.zentar` — use `get_zentar_home()` from `zentar_constants` for code paths and `display_zentar_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/hermes-digital-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/hermes-digital-agent/blob/main/LICENSE).
