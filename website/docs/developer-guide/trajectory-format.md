...
ZENTAR DIGITAL AI AGENT saves conversation trajectories in ShareGPT-compatible JSONL format
...
It follows the Zentar function-calling prompt template with:
