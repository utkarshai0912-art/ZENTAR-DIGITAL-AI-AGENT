...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/research/qmd` |
...
ZENTAR DIGITAL AI AGENT via the native MCP client. This is the preferred
...
Then configure ZENTAR DIGITAL AI AGENT to connect via HTTP:
