...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | ZENTAR DIGITAL AI AGENT (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ZENTAR_OSINT_CACHE/icij/ (default: ~/.cache/zentar-osint/icij/).
...
# Set ZENTAR_OSINT_UA=your-app/1.0 (your@email) to identify yourself
