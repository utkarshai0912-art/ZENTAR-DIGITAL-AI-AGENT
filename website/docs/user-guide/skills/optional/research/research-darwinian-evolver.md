...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), ZENTAR DIGITAL AI AGENT |
| License | MIT |
...
import upstream classes into Zentar itself.
...
```bash
mkdir -p ~/.zentar/cache/darwinian-evolver && cd ~/.zentar/cache/darwinian-evolver
...
```bash
cd ~/.zentar/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.zentar/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.zentar/skills/research/darwinian-evolver
DE_DIR=~/.zentar/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Zentar core.
   Custom driver scripts under `~/.zentar/skills/...` are user-side and fine.
