...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.zentar/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.zentar/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Zentar installs package this)
