...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), ZENTAR DIGITAL AI AGENT |
| License | MIT |
...
The script reads `${ZENTAR_HOME:-~/.zentar}/.env` for two optional defaults:
...
Helper script: `~/.zentar/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.zentar/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ZENTAR_HOME:-~/.zentar}/.env`.
...
```bash
python3 ~/.zentar/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.zentar/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
