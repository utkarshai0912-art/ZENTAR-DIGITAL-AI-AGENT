...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), ZENTAR DIGITAL AI AGENT |
| License | MIT |
...
Helper script path: `~/.zentar/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.zentar/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.zentar/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.zentar/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
