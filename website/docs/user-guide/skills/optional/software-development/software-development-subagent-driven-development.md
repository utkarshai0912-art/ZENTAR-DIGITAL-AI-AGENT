...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | ZENTAR DIGITAL AI AGENT (adapted from obra/superpowers) |
| License | MIT |
