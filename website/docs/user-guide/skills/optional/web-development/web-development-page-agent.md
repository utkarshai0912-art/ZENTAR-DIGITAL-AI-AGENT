...
- User wants **Zentar itself to drive a browser** → use Zentar' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
