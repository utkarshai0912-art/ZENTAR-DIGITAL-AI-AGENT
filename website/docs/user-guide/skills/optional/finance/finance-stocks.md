...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), ZENTAR DIGITAL AI AGENT |
| License | MIT |
...
```
SCRIPT=~/.zentar/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.zentar/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
