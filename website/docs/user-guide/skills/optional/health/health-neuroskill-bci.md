...
| | |
|---|---|
| Source | Optional — install with `zentar skills install official/health/neuroskill-bci` |
...
Connect Zentar to a running [NeuroSkill](https://neuroskill.com/) instance to read
