...
| Version | `4.0.0` |
| Author | 0xbyt4, ZENTAR DIGITAL AI AGENT |
| License | MIT |
...
```bash
python3 -m pyfiglet "ZENTAR" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ZENTAR&font=Slant" | boxes -d stone
```
