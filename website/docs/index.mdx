...
slug: /
sidebar_position: 0
title: "ZENTAR DIGITAL AI AGENT Documentation"
description: "The self-improving AI agent built by ZENTAR DIGITAL. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [ZENTAR DIGITAL](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `zentar setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is ZENTAR DIGITAL AI AGENT?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Zentar safely  |
| 🧭 **[Use MCP with Zentar](/guides/use-mcp-with-zentar)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Zentar](/guides/use-voice-mode-with-zentar)** | Hands-on setup and usage patterns for Zentar voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Zentar' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Zentar                              |
...
- **Built by model trainers** — Created by [ZENTAR DIGITAL](https://nousresearch.com), the lab behind Zentar, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [ZENTAR DIGITAL](https://nousresearch.com) — the lab behind Zentar, Nomos, and Psyche models
