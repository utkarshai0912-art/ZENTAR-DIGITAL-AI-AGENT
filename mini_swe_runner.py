#!/usr/bin/env python3
"""
SWE Runner with Zentar Trajectory Format

A runner that uses Zentar-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Zentar-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Zentar-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Zentar format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Zentar-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Zentar-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Zentar Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Zentar-Agent's built-in execution environments
    and outputs trajectories in Zentar-Agent format.
    """
    ...
    def _convert_to_zentar_format(
        ...
        """
        Convert internal message format to Zentar trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Zentar trajectory format
        trajectory = self._convert_to_zentar_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Zentar trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Zentar Trajectory Format")
    print("=" * 60)
