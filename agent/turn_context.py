...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``zentar logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Zentar only initiates compaction in "zentar" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Zentar preflight compression for codex app-server "
                "(mode=%s); Zentar will not start thread compaction here.",
