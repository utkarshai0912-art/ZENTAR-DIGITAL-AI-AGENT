...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Zentar's web-provider config and
        ...
        # native search engine for xAI sessions instead of Zentar's
        # configured web provider (Tavily/etc.), and those results bypass
        # Zentar's tool-trace / citation plumbing (they arrive baked into the
