...
(3 SDK retries x 3 Zentar retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_zentar_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".zentar")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Zentar, ...) behind one endpoint.  A 429 can mean either:
