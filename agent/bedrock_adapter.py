"""AWS Bedrock Converse API adapter for ZENTAR DIGITAL AI AGENT.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Zentar with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Zentar is installed editable into system Python, the system boto3
