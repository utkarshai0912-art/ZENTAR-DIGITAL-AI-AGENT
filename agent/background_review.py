...
See the ``zentar-digital-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Zentar, e.g. 'zentar-digital-agent').\n"
    "  • Hub-installed skills (installed via 'zentar skills install').\n"
    "Pinned skills (marked via 'zentar curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("ZENTAR_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _zentar_now() timestamp, fresh
