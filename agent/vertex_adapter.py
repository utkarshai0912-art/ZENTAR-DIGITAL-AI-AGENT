"""Vertex AI (Google Cloud) adapter for ZENTAR DIGITAL AI AGENT.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Zentar to use Gemini models via Google Cloud with
...
# who installed plain `zentar-digital-agent` and only later selected a Gemini model.
try:
