...
MoA-enabled; the normal ZENTAR DIGITAL AI AGENT loop still owns tool calling and turn
...
def _reference_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    conversation flow, but flatten it into clean user/assistant *text* turns:
      ...
      - system prompt: dropped (8K of Zentar boilerplate, not advisory signal).
...
def _preset_temperature(preset: dict[str, Any], key: str) -> float | None:
    ...
    single-model ZENTAR DIGITAL AI AGENT (which never sends temperature unless
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "ZENTAR DIGITAL AI AGENT. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal ZENTAR DIGITAL AI AGENT loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
