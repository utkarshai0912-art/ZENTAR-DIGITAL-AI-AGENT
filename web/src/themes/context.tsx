...
const STORAGE_KEY = "zentar-dashboard-theme";
...
const FONT_STORAGE_KEY = "zentar-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zentar_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "zentar-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-zentar-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-zentar-theme-font", "true");
