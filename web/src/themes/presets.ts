 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `zentar_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Zentar Teal",
  description: "Classic dark teal — the canonical Zentar look",
  palette: {
...
export const manusTheme: DashboardTheme = {
  name: "manus",
  label: "Manus",
  description: "Clean dark — inspired by Manus AI",
  palette: {
    background: { hex: "#111111", alpha: 1 },
    midground: { hex: "#f5e6d3", alpha: 1 },
    foreground: { hex: "#ffffff", alpha: 0 },
    warmGlow: "rgba(217, 119, 6, 0.25)",
    noiseOpacity: 0.4,
  },
  typography: {
    ...DEFAULT_TYPOGRAPHY,
  ...
  terminalForeground: "#e0d5c7",
  seriesColors: {
    inputTokenAccent: "#f5e6d3",
    outputTokenAccent: "#d97706",
  },
  swatchColors: ["#111111", "#f5e6d3", "#d97706"],
};
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Zentar Teal (Large)",
  description: "Zentar Teal with bigger fonts and roomier spacing",
