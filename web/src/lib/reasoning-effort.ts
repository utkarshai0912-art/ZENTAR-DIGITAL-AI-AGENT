 ...
 *
 * Values mirror zentar_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Zentar default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Zentar' default when unset). */
