...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateZentar: string;
    updateZentarConfirmMessage?: string;
    updateZentarConfirmNow?: string;
    updateZentarConfirmTitle?: string;
    updatingZentar: string;
  ...
  // ── Achievements plugin (plugins/zentar-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
