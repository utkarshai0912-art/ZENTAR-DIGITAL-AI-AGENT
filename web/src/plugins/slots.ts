 ...
 * `window.__ZENTAR_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Zentar brand in the top bar
 ...
 *  `window.__ZENTAR_PLUGINS__.registerSlot(...)`.
 *
