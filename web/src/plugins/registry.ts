 ...
 *
 * Plugins call window.__ZENTAR_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ZENTAR_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ZENTAR_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ZENTAR_PLUGIN_SDK__ = {
    ...
    // window.__ZENTAR_SESSION_TOKEN__ directly.
    authedFetch,
