/**
 * Zentar Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ZENTAR_PLUGIN_SDK__`` and
 * ``window.__ZENTAR_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ZENTAR_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``ZentarPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@zentar/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ZENTAR_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ZENTAR_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ZENTAR_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface ZentarPluginSDK {
...
declare global {
  interface Window {
    __ZENTAR_PLUGIN_SDK__?: ZentarPluginSDK;
    __ZENTAR_PLUGINS__?: PluginRegistry;
  }
}
