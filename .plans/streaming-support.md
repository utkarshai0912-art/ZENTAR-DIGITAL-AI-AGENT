# Streaming LLM Response Support for ZENTAR DIGITAL AI AGENT
...
```
ZENTAR_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZENTAR_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zentar_cli/config.py` | 1 | +streaming config defaults |
