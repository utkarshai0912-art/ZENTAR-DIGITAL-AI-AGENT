...
cd apps/desktop
XCURSOR_SIZE=24 ZENTAR_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/zentar-typing
# → /tmp/zentar-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/zentar-typing.before.heapsnapshot
# → /tmp/zentar-typing.after.heapsnapshot
```
