...
// even though a fresh shell — and the Zentar CLI — sees it immediately. The
// desktop's ZENTAR_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\zentar. Reading
...
//       ZENTAR_HOME    REG_SZ    F:\Zentar\data
//
