 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/zentar-digital-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NousResearch/hermes-digital-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/zentar-digital-agent'
