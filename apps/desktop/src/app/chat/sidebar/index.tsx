...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/zentar'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('zentar:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('zentar:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Zentar to
