...
import type { ProjectInfo, SessionInfo } from '@/zentar'
 ...
 * repo shows its branches/worktrees even when they have no Zentar sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ZentarGitWorktree[]
): SidebarSessionGroup[] {
