...
const FOCUS_EVENT = 'zentar:composer-focus'
const INSERT_EVENT = 'zentar:composer-insert'
const INSERT_REFS_EVENT = 'zentar:composer-insert-refs'
const SUBMIT_EVENT = 'zentar:composer-submit'
const VOICE_TOGGLE_EVENT = 'zentar:composer-voice-toggle'
