...
const TAKEOVER_KEY = 'zentar.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zentar can't clear via the API — the user
 *  sees exactly what runs instead of Zentar silently deleting their creds. */
