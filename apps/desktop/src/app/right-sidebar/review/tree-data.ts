import type { ZentarReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ZentarReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ZentarReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
