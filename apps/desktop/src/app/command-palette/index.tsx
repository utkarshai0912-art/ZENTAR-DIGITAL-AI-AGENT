...
import { getZentarConfigRecord, listAllProfileSessions } from '@/zentar'
...
// Zentar session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-zentar',
            keywords: ['update', 'upgrade', 'zentar', 'version', 'system', 'restart'],
            label: cc.updateZentar,
