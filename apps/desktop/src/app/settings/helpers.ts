...
import type { ZentarConfigRecord, ToolsetInfo } from '@/types/zentar'
...
export function getNested(obj: ZentarConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ZentarConfigRecord, path: string, value: unknown): ZentarConfigRecord {
...
function personalityOptions(config: ZentarConfigRecord): string[] {
