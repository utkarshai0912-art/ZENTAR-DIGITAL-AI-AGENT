...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: ZentarConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: ZentarConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // ZENTAR_QWEN_ shares the HERMES_ stem with other integrations.
      expect(providerGroup('ZENTAR_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
