...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/zentar'
...
// / Program Files), which buried any files Zentar wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.zentarDesktop` is
    ...
    const settings = window.zentarDesktop?.settings
