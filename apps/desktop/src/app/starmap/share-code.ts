...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/zentar'
...
const VERSION = 3
const PREFIX = 'HML' // "Zentar Memory Loadout" — namespaces our codes like WoW's leading bytes.
