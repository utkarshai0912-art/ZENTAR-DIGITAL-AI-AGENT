...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zentar Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zentar settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingZentarDesktop: 'Starting Zentar Desktop…'
    },
    errors: {
      backgroundExited: 'Zentar background process exited.',
      backgroundExitedDuringStartup: 'Zentar background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zentar backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateZentar: 'Update Zentar',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zentar Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zentar is waiting for your response.',
      turnDoneTitle: 'Zentar finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zentar defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Zentar is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zentar asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zentar was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zentar follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zentar is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zentar, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Zentar checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zentar configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zentar Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zentar backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ZENTAR_DESKTOP_REMOTE_URL and ZENTAR_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zentar backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Zentar backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /zentar.',
      ...
      restartingMessage: 'Zentar Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zentar ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zentar runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via zentar curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Zentar builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zentar to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zentar to generate pets.',
      backgroundHint: 'You can close this — Zentar will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zentar desktop' },
    ...
    zentarActiveSessions: (version, count) => `Zentar ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@zentar:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zentar environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zentar will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Zentar backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Zentar. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zentar...',
    placeholderReconnecting: 'Reconnecting to Zentar…',
    ...
    attachUrlDesc: 'Zentar will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Zentar to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Zentar…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Zentar…',
    ...
    unsupportedMessage: 'This version of Zentar can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zentar from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zentar will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zentar desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zentar updater takes over in its own window and reopens Zentar automatically when it’s done. Please don’t reopen Zentar yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zentar reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zentar reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Zentar needs a one-time install',
    ...
    settingUpTitle: 'Setting up ZENTAR DIGITAL AI AGENT',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zentar CLI or desktop instance is running. Stop any running Zentar instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ZENTAR DIGITAL AI AGENT",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zentar is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zentar…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zentar',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zentar at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zentar connects automatically',
    ...
    authorizeThere: 'Authorize Zentar there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zentar there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zentar Desktop v${version}`,
      ...
      gatewayTitle: 'Zentar inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zentar will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zentar is restarting...',
      askRestart: 'Ask Zentar to restart the server',
      lookingRestart: taskId => `Zentar is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zentar is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zentar finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zentar could not restart the server.',
      stillWorking:
        'Zentar is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zentar is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zentar gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.zentar/config.yaml). Zentar won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zentar needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zentar needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zentar Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zentar Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `zentar gateway` running?'
    }
  },
