...
import type { ZentarGitWorktree, ZentarRepoStatus } from '@/global'
...
export const $repoStatus = atom<ZentarRepoStatus | null>(null)
...
export const $repoWorktrees = atom<ZentarGitWorktree[]>([])
