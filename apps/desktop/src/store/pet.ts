...
export interface PetInfo {
  ...
  // the Zentar "run" activity state uses the in-place running row).
 ...
 * ZENTAR_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'zentar.desktop.pet-roam.v1'
